...
var Application = function() {
    ...
    const loadList = 
		<div>
			<div onclick="application.goToTargetView(event)" id="ID2_Best_Screwdriver">
				<span>2. data[2]</span>
			</div>
			<div id="ID3_Spicy_Buffalo-Style_Meatba">
				<span>3.data[3]</span>
			</div>
			<div onclick="application.goToTargetView(event)" id="ID1_Quick_and_Easy_Strawberry_">
				<span>1. data[1]</span>
			</div>
			<div id="ID4_Kims_Summer_Cucumber_Pasta">
				<span>4. data[4]</span>
			</div>
			<div id="ID6_Cookies_N_Crme_Cream_Chees">
				<span>6. data[6]</span>
			</div>
			<div id="ID7_Potato_Waffles">
				<span>7. data[7]</span>
			</div>
			<div id="ID5_Oatmeal_Butterscotch_Cooki">
				<span>5. data[5]</span>
			</div>
			<div id="ID8_Dark_Chocolate_Molasses_Co">
				<span>8. data[8]</span>
			</div>
			<div id="ID9_Orange_Bread_II">
				<span>9. data[9]</span>
			</div>
			<div id="ID10_Slow_Cooker_Hawaiian_Chic">
				<span>10. data[10]</span>
			</div>
		</div>

	ReactDOM.render(loadList, document.getElementById('loadList'));
