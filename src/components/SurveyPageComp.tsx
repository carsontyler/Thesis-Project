        ...
        <div>
          <View style={{ flexDirection: "row" }}>
            <View style={{ flex: 1, flexDirection: "column", padding: '15px' }}>
              ...
              <View style={{ flexDirection: "row" }} >
                <p>Click through the recommended recipes and observe how they are related to the recipe you selected. <b>Don't worry about how they relate to the scenario</b>, it only matters how they relate to the selected recipe. Then, fill out the survey.</p>
              </View>
              <View style={{ flexDirection: "row", alignSelf: 'center' }} >
              ...
              <View style={{ flexDirection: "row", padding: '10px' }}>
                <View style={{ flex: 1, flexDirection: "column" }}>
                  ...
                  >
                    ...
                    {props.tempCurrentRecipe !== props.certainRecipes[0] && (
                      <span>1. <span className="recipe-item" style={{ color: '#ffdd00' }}>{props.certainRecipes[0].title}</span></span>
                    )}
                  </div>
                  ...
                  >
                    ...
                    {props.tempCurrentRecipe !== props.certainRecipes[1] && (
                      <span>2. <span className="recipe-item" style={{ color: '#ffdd00' }}>{props.certainRecipes[1].title}</span></span>
                    )}
                  </div>
                  ...
                  >
                    ...
                    {props.tempCurrentRecipe !== props.certainRecipes[2] && (
                      <span>3. <span className="recipe-item" style={{ color: '#ffdd00' }}>{props.certainRecipes[2].title}</span></span>
                    )}
                  </div>
                  <div
                    id="recipe4"
                  ...
                  >
                    ...
                    {props.tempCurrentRecipe !== props.certainRecipes[3] && (
                      <span>4. <span className="recipe-item" style={{ color: '#ffdd00' }}>{props.certainRecipes[3].title}</span></span>
                    )}
                  </div>
                  <div
                    id="recipe5"
                  ...
                  >
                    ...
                    {props.tempCurrentRecipe !== props.certainRecipes[4] && (
                      <span>5. <span className="recipe-item" style={{ color: '#ffdd00' }}>{props.certainRecipes[4].title}</span></span>
                    )}
                  </div>
                </View>
              </View>
            ...
            <View style={{ flex: 1, flexDirection: "column", padding: '15px' }}>
              <div>
                <SurveyComp
                  submitSurvey={props.submitSurvey}
                  recipe={props.currentRecipe}
                  similarRecipes={props.certainRecipes}
                  groupId={props.groupdId}
                  displayNum={props.displayNum}
                />
              </div>
